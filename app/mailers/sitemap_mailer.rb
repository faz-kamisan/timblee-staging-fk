class SitemapMailer < ActionMailer::Base
  ...
  def send_share_link(email, inviter_name, sitemap_id, custom_message)
    ...
    @custom_message_header = "Here is a personal message from #{@inviter_name}" if custom_message.present?
