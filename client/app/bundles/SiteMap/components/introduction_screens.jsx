    ...
    return (
      <div className="public-intro">
        <div className="intro-box-2">
          <span className={ "hotspot " + (this.state.showSecondScreenHandle ? '' : 'hide')} onClick={function(e) { _this.setIntroSlideNumber(2) } }></span>
        ...
        <div className="intro-box-3">
          <span className={ "hotspot " + (this.state.showThirdScreenHandle ? '' : 'hide')} onClick={function(e) { _this.setIntroSlideNumber(3) } }></span>
